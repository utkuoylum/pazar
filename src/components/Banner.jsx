  ...
  return (
    <div className="w-full h-auto overflow-x-hidden">
      <div className="w-screen h-sliderHeight relative">
        <div className="h-full w-[400vw] flex transition-transform duration-1000" style={{transform: `translateX(-${slide * 100}vw`}}>
          {data.map(item => <img src={item} alt="slider image" 
